# National Parks PHP API library

The National Parks PHP library provides convenient access to the National Parks REST API from any PHP 8.1.0+ application.
...
List methods in the National Parks API are paginated.
...
$result = $client->activities->list(requestOptions: ['maxRetries' => 5]);
```
