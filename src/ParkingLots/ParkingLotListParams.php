...
/**
 * @see Nps\Services\ParkingLotsService::list()
 *
 * @phpstan-type ParkingLotListParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class ParkingLotListParams implements BaseModel
{
    /** @use SdkModel<ParkingLotListParamsShape> */
    use SdkModel;
    use SdkParams;
