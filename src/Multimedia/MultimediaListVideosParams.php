...
/**
 * @see Nps\Services\MultimediaService::listVideos()
 *
 * @phpstan-type MultimediaListVideosParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class MultimediaListVideosParams implements BaseModel
{
    /** @use SdkModel<MultimediaListVideosParamsShape> */
    use SdkModel;
    use SdkParams;
