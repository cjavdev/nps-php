...
/**
 * @see Nps\Services\Multimedia\GalleriesService::list()
 *
 * @phpstan-type GalleryListParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class GalleryListParams implements BaseModel
{
    /** @use SdkModel<GalleryListParamsShape> */
    use SdkModel;
    use SdkParams;
