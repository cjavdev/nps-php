...
/**
 * @see Nps\Services\MultimediaService::listAudio()
 *
 * @phpstan-type MultimediaListAudioParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class MultimediaListAudioParams implements BaseModel
{
    /** @use SdkModel<MultimediaListAudioParamsShape> */
    use SdkModel;
    use SdkParams;
