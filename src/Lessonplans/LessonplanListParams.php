...
/**
 * @see Nps\Services\LessonplansService::list()
 *
 * @phpstan-type LessonplanListParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class LessonplanListParams implements BaseModel
{
    /** @use SdkModel<LessonplanListParamsShape> */
    use SdkModel;
    use SdkParams;
