...
/**
 * @see Nps\Services\WebcamsService::list()
 *
 * @phpstan-type WebcamListParamsShape = array{
 *   id?: string|null,
 *   limit?: int|null,
 ...
 * }
 */
final class WebcamListParams implements BaseModel
{
    /** @use SdkModel<WebcamListParamsShape> */
    use SdkModel;
    use SdkParams;
