...
/**
 * @see Nps\Services\CampgroundsService::list()
 *
 * @phpstan-type CampgroundListParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class CampgroundListParams implements BaseModel
{
    /** @use SdkModel<CampgroundListParamsShape> */
    use SdkModel;
    use SdkParams;
