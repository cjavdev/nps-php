...
/**
 * @see Nps\Services\PassportStampLocationsService::list()
 *
 * @phpstan-type PassportStampLocationListParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class PassportStampLocationListParams implements BaseModel
{
    /** @use SdkModel<PassportStampLocationListParamsShape> */
    use SdkModel;
    use SdkParams;
