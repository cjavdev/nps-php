...
use Nps\RoadEvents\RoadEventListResponseItem\Feature;
use Nps\RoadEvents\RoadEventListResponseItem\RoadEventFeedInfo;

/**
 * @phpstan-import-type FeatureShape from \Nps\RoadEvents\RoadEventListResponseItem\Feature
 * @phpstan-import-type RoadEventFeedInfoShape from \Nps\RoadEvents\RoadEventListResponseItem\RoadEventFeedInfo
 *
 * @phpstan-type RoadEventListResponseItemShape = array{
 *   features?: list<Feature|FeatureShape>|null,
 *   roadEventFeedInfo?: null|RoadEventFeedInfo|RoadEventFeedInfoShape,
 *   type?: string|null,
 * }
 */
final class RoadEventListResponseItem implements BaseModel
{
    /** @use SdkModel<RoadEventListResponseItemShape> */
    use SdkModel;
