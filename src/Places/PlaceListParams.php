...
/**
 * @see Nps\Services\PlacesService::list()
 *
 * @phpstan-type PlaceListParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class PlaceListParams implements BaseModel
{
    /** @use SdkModel<PlaceListParamsShape> */
    use SdkModel;
    use SdkParams;
