...
use Nps\ServiceContracts\ParkingLotsContract;

/**
 * @phpstan-import-type RequestOpts from \Nps\RequestOptions
 */
final class ParkingLotsService implements ParkingLotsContract
{
    /**
     * @api
     */
    public ParkingLotsRawService $raw;
    ...
    {
        $this->raw = new ParkingLotsRawService($client);
    }
