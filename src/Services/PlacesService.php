 ...
 */
final class PlacesService implements PlacesContract
{
    /**
     * @api
     */
    public PlacesRawService $raw;
    ...
    {
        $this->raw = new PlacesRawService($client);
    }
     ...
     *
     * @return LimitStartPagination<PlaceListResponse>
     *
     * @throws APIException
     */
