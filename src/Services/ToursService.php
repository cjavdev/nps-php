 ...
 */
final class ToursService implements ToursContract
{
    /**
     * @api
     */
    public ToursRawService $raw;
    ...
    {
        $this->raw = new ToursRawService($client);
    }

    /**
     * @api
     *
     * @param list<string> $id a comma delimited list of tour IDs
     ...
     *
     * @return LimitStartPagination<TourListResponse>
     *
     * @throws APIException
     */
