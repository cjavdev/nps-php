 ...
 */
final class NewsReleasesService implements NewsReleasesContract
{
    /**
     * @api
     */
    public NewsReleasesRawService $raw;
    ...
    {
        $this->raw = new NewsReleasesRawService($client);
    }
