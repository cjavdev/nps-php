...
/**
 * @see Nps\Services\AlertsService::list()
 *
 * @phpstan-type AlertListParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class AlertListParams implements BaseModel
{
    /** @use SdkModel<AlertListParamsShape> */
    use SdkModel;
    use SdkParams;
