...
/**
 * @see Nps\Services\VisitorCentersService::list()
 *
 * @phpstan-type VisitorCenterListParamsShape = array{
 *   limit?: int|null,
 ...
 * }
 */
final class VisitorCenterListParams implements BaseModel
{
    /** @use SdkModel<VisitorCenterListParamsShape> */
    use SdkModel;
    use SdkParams;
