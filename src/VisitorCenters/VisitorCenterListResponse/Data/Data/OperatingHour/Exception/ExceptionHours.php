...
namespace Nps\VisitorCenters\VisitorCenterListResponse\Data\Data\OperatingHour\Exception;
...
/**
 * @phpstan-type ExceptionHoursShape = array{
 *   friday?: string|null,
 *   monday?: string|null,
 ...
 * }
 */
final class ExceptionHours implements BaseModel
{
    /** @use SdkModel<ExceptionHoursShape> */
    use SdkModel;
